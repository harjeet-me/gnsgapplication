...
export class ProgramComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    if (this.currentSearch) {
      this.programService
        ...
        .subscribe(
          (res: HttpResponse<IProgram[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
          () => this.onError()
        );
      return;
    }
  ...
  protected onSuccess(data: IProgram[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
