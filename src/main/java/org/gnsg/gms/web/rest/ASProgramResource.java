...
public class ASProgramResource {
    ...
    public ResponseEntity<List<ASProgram>> getAllASPrograms(
        Pageable pageable,
        ...
        Page<ASProgram> page;
        if (eagerload) {
            page = aSProgramService.findAllWithEagerRelationships(pageable);
        } else {
            page = aSProgramService.findAll(pageable);
        }
